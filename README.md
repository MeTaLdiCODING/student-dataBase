...
Консольное приложение с  MVC-подобной структурой для управления базой данных студентов.  
Мой первый полноценный пет-проект на Java.
...
Проект разработан с целью отработки навыков.
